		...
		>
			<div className="container mx-auto flex flex-col md:flex-row justify-between items-start">
				<div className="w-full md:w-1/3 mb-8 md:mb-0">
					<h2 className="text-white text-xl md:text-[28px] md:font-bold">
						WanderLust
					</h2>
					<p className="text-gray-400 mt-4 mb-4">
						WanderLust is your trusted travel companion, dedicated
						to crafting unforgettable journeys and connecting you to the world’s
						most beautiful destinations.
					</p>
				</div>
				<div className="w-full md:w-1/5 md:mb-0">
                    <h3 className="text-white text-lg font-bold mb-4">Company</h3>
                    <ul className="flex  flex-col gap-2 mb-4 text-gray-400"> 
